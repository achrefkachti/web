					...
					<ul class="side-menu">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<li><a href="formadvanced.html" class="slide-item"> Supprimer Suivie</a></li>
								<li><a href="formeditor.php" class="slide-item"> Afficher Formulaire</a></li>
								<li><a href="mailing.php" class="slide-item"> Envoyer Mail</a></li>
								<li><a href="stat.php" class="slide-item"> Statistique Formulaire</a></li>
								<li><a href="stat2.php" class="slide-item">Statistique Suivie</a></li>
							</ul>
						</li>
						<li class="slide">
							...
							<div class="col-lg-12">
								<div class="card">
									...
									<form method="get" action="tri.php">
										<input type="submit" value="Trier" class="btn btn-danger btn-rounded btn-sm my-0" >
									</form>
								</div>
							</div>
